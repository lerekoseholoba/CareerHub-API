...
{
    /// <inheritdoc />
    public partial class TestCheckMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "ClosingDate", "Description", "PostedDate", "SalaryMax", "SalaryMin" },
                values: new object[] { new DateTime(2025, 2, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Seed job", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 60000m, 30000m });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("00000000-0000-0000-0000-000000000001"),
                columns: new[] { "ClosingDate", "Description", "PostedDate", "SalaryMax", "SalaryMin" },
                values: new object[] { new DateTime(2026, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Description for Backend Developer position #1", new DateTime(2025, 1, 2, 0, 0, 0, 0, DateTimeKind.Utc), 31000m, 21000m });
